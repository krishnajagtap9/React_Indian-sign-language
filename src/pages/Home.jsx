    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative pt-20 lg:pt-24">
        <div className="absolute inset-0 -z-10 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-[url('https://tse4.mm.bing.net/th?id=OIP.-IUZz3zCcl1K6f9SywtnugHaEK&pid=Api&P=0&h=180?height=1080&width=1920')] bg-cover bg-center opacity-40" />
        </div>
