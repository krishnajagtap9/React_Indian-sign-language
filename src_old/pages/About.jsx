  ...
  const developers = [
    {
      ...
      socialLinks: [
        { icon: <Linkedin className="h-5 w-5" />, hoverIcon: <Linkedin className="h-5 w-5 text-blue-600" />, url: "#" },
        {
    ...
    },
    {
      ...
      socialLinks: [
        ...
        },
        {
          ...
          hoverIcon: <MessageSquare className="h-5 w-5 text-green-600" />,
          url: "#",
        },
      ],
    },
      ...
      <div className="space-y-12">
        {[
          ...
          <div key={index} className="relative pl-20 md:pl-0">
            {/* Timeline Year Badge */}
            <div className="absolute left-0 top-0 flex items-center justify-center w-16 h-16 rounded-full bg-primary text-primary-foreground font-bold md:left-1/2 md:transform md:-translate-x-1/2">
...
>
  ...
  <div className="relative container mx-auto px-4 text-center" data-aos="zoom-in-up">
    ...
    <Link
      to="/contact"
      className="inline-flex items-center gap-2 rounded-md bg-primary text-primary px-6 py-3 font-medium transition-all hover:bg-gray-100"
    >
      Get Involved
    </Link>
  </div>
